...
public class SendOTPLogistics extends AppCompatActivity {
    //DECLARE VARIABLES
    //xml
    Button verify;
    TextView txt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.send_otp_logistics);
        ...
        //CONNECT XML
        entercode = findViewById(R.id.ed1);
        txt = findViewById(R.id.txt1);
        Resend = findViewById(R.id.btn2);
        verify = findViewById(R.id.btn1);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            //not signed in
                            ReusableCodeForAll.ShowAlert(SendOTPLogistics.this, "Error", task.getException().getMessage());
                        }
                    }
                });
    }
