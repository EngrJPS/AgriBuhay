package com.AgriBuhayProj.app.DeliveryFoodPanel;
...
public class DeliveryPendingOrderView extends AppCompatActivity {
    ...
    private void deliveryorders() {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("DeliveryShipOrders").child(deliveryId).child(RandomUID).child("OtherInformation");
